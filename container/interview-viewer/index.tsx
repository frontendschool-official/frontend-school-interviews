                  ...
                  <>
                    <ProblemContent>
                      ...
                      {problem?.interviewType === "dsa" &&
                        problem?.problem && (
                          <DSAProblemRenderer problem={problem?.problem as IDSAProblem} />
                        )}
                  ...
                  <div className="flex items-center space-x-3">
                    {problem?.interviewType === "coding" &&
                      problem?.problem && (
                        <EvaluateButton
                          ...
                          problemTitle={
                            (problem?.problem as IMachineCodingProblem)?.title ||
                            problem?.designation
                          }
                          problemStatement={
                            (problem?.problem as IMachineCodingProblem)?.description || ""
                          }
                        />
                      )}
                    {problem?.interviewType === "design" && isCanvasReady && (
                      <EvaluateButton
                        ...
                        problemStatement={
                          (problem?.problem as ISystemDesignProblem)?.description || ""
                        }
                      />
                    )}
                    {problem?.interviewType === "dsa" && (
