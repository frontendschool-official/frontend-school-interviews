...
const FeatureSection = () => {
  ...
  return (
    <section className='py-12 sm:py-16 md:py-24 px-4 sm:px-8 bg-secondary'>
      <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-center mb-4 text-text'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto'>
        <div className='bg-bodyBg p-6 sm:p-8 md:p-10 rounded-2xl border border-border text-center transition-all duration-300 animate-[fadeInUp_1s_ease-out] hover:-translate-y-2 hover:shadow-xl hover:shadow-border/30'>
          <div className='w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 text-2xl sm:text-3xl text-white animate-[float_3s_ease-in-out_infinite]'>
            💻
          </div>
