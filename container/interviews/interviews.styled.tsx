...
export const ProblemHeader: React.FC<ProblemHeaderProps> = ({ children }) => (
  <div className="p-6 border-b border-border bg-bodyBg">
    {children}
  </div>
);

export const ProblemContent: React.FC<ProblemContentProps> = ({ children }) => (
  <div className="p-6 bg-bodyBg overflow-y-auto">
    {children}
  </div>
);
...
export const OutputPanel: React.FC<OutputPanelProps> = ({ children, isVisible = true }) => (
  <div className={`bg-secondary border-t border-border h-48 overflow-y-auto transition-all duration-300 ${
...
export const Resizer: React.FC<ResizerProps> = ({ children, onResize, onMouseDown }) => (
  <div 
...
export const CollapseButton: React.FC<CollapseButtonProps> = ({ children, onClick }) => (
  <button 
    onClick={onClick}
...
export const Tab: React.FC<TabProps> = ({ children, active = false, onClick }) => (
  <button
    onClick={onClick}
