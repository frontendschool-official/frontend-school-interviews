...
import { FaGithub, FaCode, FaRobot, FaChartLine, FaLaptopCode } from "react-icons/fa";
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-white/80 leading-relaxed">
              Continue your journey to ace frontend interviews with personalized practice and progress tracking.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/90">Your Personal Progress Dashboard</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 bg-primary/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-primary/40">
                <span className="text-white text-xs font-bold">✓</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/90">Track Your Interview Preparation</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12 min-h-0">
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="lg:hidden text-center mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold text-text mb-4">Sign In to Frontend School</h1>
              <p className="text-neutral text-sm sm:text-base">Access 1000+ interview problems and AI-powered feedback</p>
            </div>
            
            {/* Login Card */}
            <div className="bg-bodyBg lg:bg-secondary lg:border lg:border-border lg:rounded-2xl lg:p-8 lg:shadow-card">
              <div className="text-center mb-8">
                <h2 className="text-2xl lg:text-3xl font-bold text-text mb-3">Sign In</h2>
                <p className="text-neutral text-lg">Access premium interview preparation resources and join thousands of successful developers</p>
              </div>
              ...
              <div className="my-8 flex items-center">
                ...
                <span className="px-4 text-sm text-neutral bg-bodyBg lg:bg-secondary">Quick & Secure Login</span>
                <div className="flex-1 border-t border-border"></div>
              </div>
              ...
              <div className="mt-8 text-center space-y-4">
                <p className="text-sm text-neutral">
                  Don't have an account? <span className="text-primary font-semibold cursor-pointer hover:underline">Sign up for free</span>
                </p>
