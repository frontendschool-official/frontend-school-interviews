...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-8 animate-fade-in">
      {/* Profile Header */}
      <div className="flex items-center gap-8 mb-12 p-8 bg-secondary rounded-2xl shadow-lg md:flex-col md:text-center">
        <div className="w-30 h-30 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-3xl text-white overflow-hidden relative">
        ...
        <div className="flex-1">
          <h1 className="text-4xl font-bold text-text mb-2">{userProfile.displayName}</h1>
          <p className="text-lg text-text opacity-80 mb-4 flex items-center gap-2">
            <FaEnvelope />
            {userProfile.email}
          </p>
          <p className="text-sm text-text opacity-60 flex items-center gap-2">
            <FaCalendar />
        ...
        <button
          ...
          className="bg-gradient-to-r from-primary to-accent text-white border-none px-6 py-3 rounded-full font-semibold cursor-pointer transition-all duration-300 flex items-center gap-2 hover:-translate-y-0.5 hover:shadow-lg"
        >
          <FaEdit />
          Edit Profile
        </button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
        <div className="bg-secondary p-5 rounded-xl text-center shadow-lg transition-transform duration-300 hover:-translate-y-1">
          <div className="text-2xl text-primary mb-4">
            <FaTrophy />
          </div>
          <div className="text-2xl font-bold text-text mb-2">{userProfile.stats.totalProblemsCompleted}</div>
          <div className="text-sm text-text opacity-80">Problems Completed</div>
        </div>
        ...
        <div className="bg-secondary p-5 rounded-xl text-center shadow-lg transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="text-2xl font-bold text-text mb-2">{userProfile.stats.currentStreak}</div>
          <div className="text-sm text-text opacity-80">Day Streak</div>
        </div>
        ...
        <div className="bg-secondary p-5 rounded-xl text-center shadow-lg transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="text-2xl font-bold text-text mb-2">{userProfile.stats.totalProblemsAttempted}</div>
          <div className="text-sm text-text opacity-80">Problems Attempted</div>
        </div>
        ...
        <div className="bg-secondary p-5 rounded-xl text-center shadow-lg transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="text-2xl font-bold text-text mb-2">{Math.round(userProfile.stats.averageScore)}%</div>
          <div className="text-sm text-text opacity-80">Average Score</div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 justify-end mt-6">
                <button
                  ...
                  className="px-6 py-3 rounded-lg font-semibold border-2 border-border bg-transparent text-text cursor-pointer transition-all duration-300 flex items-center gap-2 hover:border-primary hover:text-primary"
                >
                  <FaTimes />
                  Cancel
                </button>
                <button
                  ...
                  className="px-6 py-3 rounded-lg font-semibold border-none cursor-pointer transition-all duration-300 flex items-center gap-2 bg-gradient-to-r from-primary to-accent text-white hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-60"
                >
                  <FaSave />
