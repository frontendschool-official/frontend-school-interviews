...
export const ProblemCardSkeleton: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`bg-secondary border border-border rounded-xl p-6 hover:shadow-lg transition-all duration-300 ${className}`}>
...
export const DashboardCardSkeleton: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`bg-secondary border border-border rounded-xl p-6 flex items-center gap-4 ${className}`}>
    <Skeleton width={48} height={48} rounded="xl" />
...
export const GridSkeleton: React.FC<{ 
  ...
  <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-${columns} gap-4 sm:gap-6 ${className}`}>
