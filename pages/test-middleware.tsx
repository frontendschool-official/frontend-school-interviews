  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Test the authentication middleware functionality" />
      </Head>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                This page tests the authentication middleware that automatically adds the user ID 
                to the <code className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">X-USER-ID</code> header 
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                ...
                <ol className="list-decimal list-inside text-blue-800 dark:text-blue-200 space-y-1">
                  <li>User makes an authenticated API request with Firebase ID token</li>
                  <li>Middleware intercepts the request and verifies the token</li>
                  <li>Middleware extracts the user ID and adds it to <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">X-USER-ID</code> header</li>
                  <li>API route can access the user ID from the header instead of request body</li>
                </ol>
              </div>
