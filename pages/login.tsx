  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="keywords" content="frontend interviews, coding practice, sign in, login, programming challenges, tech interviews, JavaScript, React, system design" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://frontendschool.dev/login" />
        <meta property="og:title" content="Sign In - Frontend School | Master Frontend Interviews" />
        <meta 
        ...
        <meta property="twitter:url" content="https://frontendschool.dev/login" />
        <meta property="twitter:title" content="Sign In - Frontend School | Master Frontend Interviews" />
        <meta 
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Sign in to access premium frontend interview preparation resources including coding problems, system design practice, and AI-powered feedback.",
            "url": "https://frontendschool.dev/login",
            "mainEntity": {
              "@type": "EducationalOrganization",
              "name": "Frontend School",
              "description": "Master frontend interviews with real questions from top tech companies",
              "offers": {
                "@type": "Course",
                "name": "Frontend Interview Preparation",
                "description": "Comprehensive frontend interview preparation with 1000+ problems, AI feedback, and mock interviews"
              }
            }
          })}
        </script>
