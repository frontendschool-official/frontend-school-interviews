...
const RoadmapPage: NextPage = () => {
  ...
  const { loading, error, generateRoadmap, resetState } = useRoadmapGeneration();
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-text opacity-80 mb-8 sm:mb-10 leading-relaxed">
                Personalized learning paths tailored to your career goals. Track progress, 
                master skills, and ace your interviews with structured guidance.
              </p>
              <Button
            ...
            {loadingRoadmaps ? (
              ...
              <div className="flex flex-col items-center justify-center min-h-96 py-16 px-4 text-center">
                ...
                <p className="text-lg sm:text-xl text-text opacity-70 mb-8 max-w-2xl leading-relaxed">
                  Create your first learning roadmap to begin your structured interview preparation journey. 
                  We'll guide you through every step.
                </p>
                <Button onClick={handleOpenCreateModal} size="lg" leftIcon={<span>🚀</span>}>
              ...
              <>
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between mb-6">
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-neutralDark mb-2">Your Roadmaps</h2>
                    <p className="text-text opacity-70">
                      {userRoadmaps.length} roadmap{userRoadmaps.length !== 1 ? 's' : ''} • Keep learning and growing
                    </p>
                  </div>
                  <div className="flex items-center justify-between md:justify-end gap-3">
                    ...
                    />
                    <Button onClick={handleOpenCreateModal} className="hidden sm:inline-flex" leftIcon={<span>+</span>}>
                      New Roadmap
                    </Button>
                  </div>
                </div>
                    ...
                    >
                      <div className="p-6 sm:p-8">
                        ...
                        <div className="flex items-start justify-between mb-6">
                          ...
                          <span className={`ml-4 px-3 py-1.5 text-xs sm:text-sm rounded-full border font-semibold flex-shrink-0 ${getStatusColor(roadmap.status)}`}>
                            {roadmap.status}
                          </span>
                        </div>
                        ...
                        <div className="space-y-3 mb-6">
                          <div className="flex items-center space-x-3 text-sm sm:text-base text-text opacity-70">
                            ...
                            <span className="font-medium truncate">{roadmap.designation}</span>
                          </div>
                          <div className="flex items-center space-x-3 text-sm sm:text-base text-text opacity-70">
                            ...
                            <span className="font-medium truncate">
                              {roadmap.companies.slice(0, 2).join(", ")}{roadmap.companies.length > 2 ? "..." : ""}
                            </span>
                          </div>
                          <div className="flex items-center space-x-3 text-sm sm:text-base text-text opacity-70">
                            ...
                            <span className="font-medium">{roadmap.duration} days</span>
                          </div>
                        </div>
                          ...
                          <div className="mb-6">
                            <div className="flex justify-between items-center text-sm sm:text-base text-text opacity-70 mb-3">
                              ...
                              <span className="font-bold text-primary">
                                {roadmap.progress.completedProblemsCount} / {roadmap.overview.totalProblems}
                              </span>
                            </div>
                        ...
                        <div className="flex items-center justify-between text-xs sm:text-sm text-text opacity-60 pt-4 border-t border-border/50">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="font-medium">{roadmap.overview.totalProblems} problems</span>
                          </div>
                        </div>
                      </div>
                    </Card>
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-text opacity-70 text-sm">Choose the companies you want to prepare for</p>
                </div>
              </div>
              {loadingCompanies ? (
                  ...
                  {companies.map((company) => (
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-bold text-neutralDark mb-2 truncate">{company.name}</h4>
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-text opacity-70 text-sm">What position are you aiming for?</p>
                </div>
              </div>
              <input
                type="text"
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-text opacity-70 text-sm">How long do you want to prepare?</p>
                </div>
              </div>
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  { days: 7, label: "1 Week", description: "Quick prep", icon: "⚡" },
                  { days: 15, label: "2 Weeks", description: "Standard prep", icon: "📅" },
                  { days: 30, label: "1 Month", description: "Comprehensive", icon: "📚" },
                  { days: 90, label: "3 Months", description: "Deep dive", icon: "🎯" },
                ].map((option) => (
                  <div
                    key={option.days}
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="font-bold text-neutralDark mb-1 text-lg">{option.label}</div>
                      <div className="text-sm text-text opacity-70">{option.description}</div>
                    </div>
                  </div>
                ))}
              </div>
