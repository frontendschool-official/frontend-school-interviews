...
import { Card, Modal, Button, Tabs, Input } from '@/components/ui';
        ...
        <div className='mb-6 sm:mb-8'>
          <div className='flex justify-between items-start mb-4 sm:mb-6 p-4 sm:p-6 bg-secondary rounded-2xl border border-border shadow-lg md:flex-row flex-col gap-4 text-center md:text-left'>
            ...
            <div>
              ...
              >
                {loading ? 'Creating...' : 'Create New Roadmap'}
              </Button>
            </div>
          </div>
        </div>
          ...
          {loadingRoadmaps ? (
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8'>
              {[1, 2, 3, 4, 5, 6].map(index => (
                <div
                  key={index}
                  className='bg-secondary border border-border rounded-xl p-6 animate-pulse'
                >
                  <div className='w-3/4 h-6 bg-border rounded mb-4'></div>
                  <div className='w-full h-4 bg-border rounded mb-2'></div>
                  <div className='w-2/3 h-4 bg-border rounded mb-6'></div>
                  ...
                  <div className='w-full h-3 bg-border rounded mb-2'></div>
