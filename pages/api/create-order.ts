...
export default async function handler(
  ...
  try {
    ...
    if (!paymentDetails.amount || !paymentDetails.currency || !paymentDetails.customerEmail) {
    ...
    if (!razorpayResponse.ok) {
      ...
      try {
        ...
        if (parsedError.error) {
          errorMessage = parsedError.error.description || parsedError.error.message || errorMessage;
        }
      } catch (e) {
