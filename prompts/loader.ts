...
const PROMPT_DATA: Record<string, PromptVersion> = {
  ...
  '1.1.0': {
    ...
    description:
      'Enhanced version with improved templates and additional context variables',
    prompts: {
      dsaProblem: {
        template:
      ...
      evaluateSubmission: {
        ...
        description:
          'Comprehensive evaluation template with detailed scoring framework',
      },
      theoryProblem: {
        template:
        ...
        description:
          'Enhanced theory problem generator with technology-specific focus',
      },
      machineCodingProblem: {
        template:
        ...
        description:
          'Enhanced machine coding problem generator with comprehensive context variables',
      },
      systemDesignProblem: {
        template:
      ...
      combinedProblem: {
        ...
        description:
          'Enhanced combined problem generator with comprehensive context variables',
      },
      mockInterviewProblem: {
        template:
          'You are creating a realistic mock interview problem for a ${designation} applying to ${companies}. This is a ${interviewType} question designed for ${difficulty} difficulty level.\n\n**Mock Interview Setup:**\n- Position: ${designation}\n- Target Company: ${companies}\n- Interview Type: ${interviewType}\n- Difficulty Level: ${difficulty}\n- Experience Level: ${experienceLevel}\n- Duration: ${duration}\n- Focus Areas: ${focusAreas}\n\n**Company Context:**\n${companyContext}\n\n**Additional Context:**\n${additionalContext}\n\nGenerate a realistic interview problem that matches ${companies} standards and tests ${focusAreas} skills appropriate for ${experienceLevel} candidates.',
        variables: [
          'designation',
          'companies',
          'interviewType',
      ...
      mockInterviewEvaluation: {
        ...
        description:
          'Comprehensive mock interview evaluation with company-specific readiness assessment',
      },
    },
  },
};
